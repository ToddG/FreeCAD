...
# This is a "light" version of the SearchBox implementation, which loads the
# actual implementation on first click
...
class SearchBoxLight(QtGui.QLineEdit):
    ...
    def __init__(
        ...
        # Thanks to
        # https://saurabhg.com/programming/search-box-using-qlineedit/ for
        # indicating a few useful options
        ...
        # needed to avoid a change of width when the clear button
        # appears/disappears
    ...
    def __getattr__(self, name):
        ...
        def f(*args, **kwargs):
            from freecad.search_bar import SearchBox
