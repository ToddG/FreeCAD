...
def loadAllWorkbenches():
    ...
    for i, wb in enumerate(lst):
        ...
        lbl.setGeometry(geo)
        lbl.repaint()
        # Probably slower with this, because it redraws the entire GUI with all tool buttons changed etc.
        # but allows the label to actually be updated, and it looks nice and gives a quick overview of
        # all the workbenches…
...
def refreshToolsAction():
    from PySide import QtGui
    print("RefreshTools: refreshToolsAction")
    ...
    reply = QtGui.QMessageBox.question(
        ...
        'Load all workbenches? This can cause FreeCAD to become unstable, and this "reload tools" '
        "feature contained a bug that crashed freecad systematically, so please make sure you "
        "save your work before. It's a good idea to restart FreeCAD after this operation.",
